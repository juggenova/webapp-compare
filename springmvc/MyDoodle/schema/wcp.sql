...
create table Vote (choice tinyint check (choice between 0 and 2), day date, id bigint not null auto_increment, poll_id bigint, version bigint not null, voter_id bigint, primary key (id)) engine=InnoDB;
